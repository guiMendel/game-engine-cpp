...
# Object files
_OBJS = main.o Game.o GameState.o Sprite.o Music.o Component.o GameObject.o Sound.o TileSet.o TileMap.o Resources.o InputManager.o Camera.o Movement.o Alien.o Health.o Minion.o Debug.o Projectile.o SpriteAnimator.o MainState.o PenguinBody.o PenguinCannon.o Collider.o
